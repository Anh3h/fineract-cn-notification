...
import io.mifos.notification.api.v1.client.NotificationManager;
import io.mifos.notification.api.v1.domain.Sample;
import io.mifos.notification.service.NotificationConfiguration;
...
public class TestSample extends SuiteTestEnvironment {
  ...
  @EnableFeignClients(basePackages = {"io.mifos.notification.api.v1.client"})
  @RibbonClient(name = APP_NAME)
  @Import({ NotificationConfiguration.class})
  @ComponentScan("io.mifos.notification.listener")
